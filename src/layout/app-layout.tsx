...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Interview', path: '/interviews', entity: 'interview', service: AccessServiceEnum.PROJECT, icon: FiMic },
    { name: 'Work', path: '/works', entity: 'work', service: AccessServiceEnum.PROJECT, icon: FiFileText },
